...
const ANIMAL_TYPES = [
  ...
  { id:'kiwi', emoji:'🥝', name:'키위새', trait:'통통하게 뒤뚱거려요', seedBonus:1.9 },
  { id:'kangaroo', emoji:'🦘', name:'캥거루',   trait:'깡충깡충 뛰어다녀요',   seedBonus:2.1 },
  { id:'deer',     emoji:'🦌', name:'사슴',     trait:'우아하게 걸어다녀요',   seedBonus:2.3 },
  { id:'horse',    emoji:'🐴', name:'말',       trait:'씩씩하게 달려요',       seedBonus:2.5 },
  { id:'camel',    emoji:'🐪', name:'낙타',     trait:'묵묵하게 걸어가요',     seedBonus:2.7 },
  { id:'elephant', emoji:'🐘', name:'코끼리',   trait:'천천히 걸어요',         seedBonus:3.0 },
  { id:'rhino',    emoji:'🦏', name:'코뿔소',   trait:'묵직하게 걸어요',       seedBonus:3.3 },
  { id:'hippo',    emoji:'🦛', name:'하마',     trait:'느릿느릿 걸어요',       seedBonus:3.6 },
  { id:'bison',    emoji:'🦬', name:'들소',     trait:'당당하게 걸어요',       seedBonus:3.9 },
  { id:'whale',   emoji:'🐋', name:'고래',     trait:'유유히 헤엄쳐요',       seedBonus:2.2 },
  { id:'dolphin', emoji:'🐬', name:'돌고래',   trait:'신나게 뛰어올라요',     seedBonus:2.4 },
  { id:'shark',   emoji:'🦈', name:'상어',     trait:'날카롭게 헤엄쳐요',     seedBonus:2.6 },
  { id:'octopus', emoji:'🐙', name:'문어',     trait:'팔을 흔들며 다녀요',    seedBonus:2.8 },
  { id:'crab',    emoji:'🦀', name:'게',       trait:'옆으로 걸어요',         seedBonus:3.0 },
  { id:'lobster', emoji:'🦞', name:'랍스터',   trait:'집게를 들고 다녀요',    seedBonus:3.2 },
  { id:'turtle',  emoji:'🐢', name:'거북이',   trait:'천천히 헤엄쳐요',       seedBonus:3.4 },
  { id:'seal',    emoji:'🦭', name:'물개',     trait:'뒤뚱뒤뚱 다녀요',      seedBonus:3.6 },
  { id:'blowfish',emoji:'🐡', name:'복어',     trait:'뽀글뽀글 헤엄쳐요',    seedBonus:3.8 },
  { id:'jellyfish',emoji:'🪼', name:'해파리',  trait:'둥실둥실 떠다녀요',     seedBonus:4.0 },
  { id:'snake',   emoji:'🐍', name:'뱀',       trait:'스르륵 기어다녀요',     seedBonus:2.1 },
  { id:'dino',    emoji:'🦖', name:'티라노',   trait:'쿵쿵 걸어다녀요',       seedBonus:2.3 },
  { id:'triceratops', emoji:'🦕', name:'브라키오', trait:'목을 늘어뜨려요',       seedBonus:2.5 },
  ...
  { id:'turkey',    emoji:'🦃', name:'칠면조',      trait:'뒤뚱뒤뚱 걸어요',      seedBonus:2.2 },
  { id:'hedgehog',  emoji:'🦔', name:'고슴도치',    trait:'조심조심 걸어요',       seedBonus:1.9 },
  { id:'skunk',     emoji:'🦨', name:'스컹크',      trait:'꼬리를 세우고 걸어요',  seedBonus:2.1 },
  { id:'otter',     emoji:'🦦', name:'수달',        trait:'재빠르게 헤엄쳐요',     seedBonus:2.4 },
  { id:'sloth',     emoji:'🦥', name:'나무늘보',    trait:'아~주 느릿느릿해요',    seedBonus:1.8 },
  { id:'gorilla',   emoji:'🦍', name:'고릴라',      trait:'쿵쿵 걸어다녀요',       seedBonus:3.1 },
  { id:'zebra',     emoji:'🦓', name:'얼룩말',      trait:'줄무늬로 달려요',       seedBonus:2.6 },
  { id:'giraffe',   emoji:'🦒', name:'기린',        trait:'목을 길게 빼고 걸어요', seedBonus:2.9 },
  { id:'tiger',     emoji:'🐅', name:'호랑이',      trait:'살금살금 다가와요',     seedBonus:3.4 },
  { id:'leopard',   emoji:'🐆', name:'표범',        trait:'날렵하게 달려요',       seedBonus:3.6 },
  { id:'monkey',    emoji:'🐒', name:'원숭이',      trait:'재빠르게 뛰어다녀요',   seedBonus:2.5 },
  { id:'mouse',     emoji:'🐁', name:'쥐',          trait:'종종종 달려요',         seedBonus:1.6 },
  { id:'chipmunk',  emoji:'🐿️', name:'다람쥐',     trait:'도토리를 모아요',       seedBonus:1.8 },
  { id:'pig',       emoji:'🐖', name:'돼지',        trait:'꿀꿀 돌아다녀요',       seedBonus:2.0 },
...
const COLLECTIBLES = [
  ...
  { id:'apple',      emoji:'🍎', name:'사과',     hint:'들판' },
  { id:'strawberry', emoji:'🍓', name:'딸기',     hint:'들판' },
  { id:'corn',       emoji:'🌽', name:'옥수수',   hint:'들판' },
  { id:'grape',      emoji:'🍇', name:'포도',     hint:'들판' },
  { id:'carrot',     emoji:'🥕', name:'당근',     hint:'들판' },
  { id:'watermelon', emoji:'🍉', name:'수박',     hint:'연못' },
  { id:'blueberry',  emoji:'🫐', name:'블루베리', hint:'연못' },
  { id:'peanut',     emoji:'🥜', name:'땅콩',     hint:'숲' },
  { id:'peach',      emoji:'🍑', name:'복숭아',   hint:'노을' },
  { id:'mango',      emoji:'🥭', name:'망고',     hint:'노을' },
  { id:'lemon',      emoji:'🍋', name:'레몬',     hint:'밤하늘' },
  { id:'olive',      emoji:'🫒', name:'올리브',   hint:'밤하늘' },
];
